# 1 Corinthians 7:38 Commentary Help Text

## BHT:
In this verse, commentators offer insights on the various options and outcomes of giving or not giving a daughter in marriage. They suggest that both actions are considered good, but with different advantages depending on the circumstances. The verse acknowledges that marriage is a remedy for human weakness, yet it also emphasizes the freedom of choice and the need to consider individual cases. The commentators stress that doing better in this context means surpassing or excelling, but it is not always obligatory.
...
3. "Her." This simple pronoun highlights the daughter as the central figure in the verse, drawing attention to her role and significance in the context of the passage.
...
### John Wesley:
1. "Doing better refers to the act of surpassing or excelling in a particular action or behavior."
2. "The phrase 'if there be no necessity' implies that doing better is not always required or obligatory."
3. "This suggests that while it is commendable to do better, it is not always necessary or expected in every situation."
